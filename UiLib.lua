...
BindButton.Size = UDim2.new(0, 100, 0, 29)
BindButton.Font = Enum.Font.GothamSemibold
BindButton.Text = ""
BindButton.TextColor3 = Color3.fromRGB(173, 216, 230)
BindButton.TextSize = 17.000
BindButton.AnchorPoint = Vector2.new(1, 0)
BindButton.Position = UDim2.new(1, 0, 0, -10)
	...
	Tab.Size = UDim2.new(0, 150, 0, 300)
	...
	ScrollTab.Size = UDim2.new(0, 150, 0, 300)
	...
	Page.Size = UDim2.new(0, 490, 0, 300)
	...
	MainPage.Size = UDim2.new(0, 490, 0, 300)
...
function main:Toggle(text, config, callback)
    ...
    Button.MouseButton1Click:Connect(function()
        if toggled == false then
            ...
            Toggle.BackgroundColor3 = Color3.fromRGB(227, 60, 60)
        end
    ...
    Sep2.TextXAlignment = Enum.TextXAlignment.Left
    Sep2.TextWrapped = true
end
function main:Line()
